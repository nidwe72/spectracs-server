...
class As7265x:
    ...
    # Legal input values: device {"AS72651","AS72652","AS72653"}, state{True, False}
        ...
        self.shutterLED("AS72652",True)
        self.shutterLED("AS72653",True)

        CALvalues = self.readCAL()
        for i in range(len(CALvalues)):
            result[nanometers[i]]=CALvalues[i]

        self.shutterLED("AS72651",False)
        self.shutterLED("AS72652",False)
        self.shutterLED("AS72653",False)
